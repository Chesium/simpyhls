...
#
# This is the DC-only solver variant kept alongside `solve_core_transient` so
# frontend integration can progress one step at a time.
#
...
#
def solve_core_dc(par_elem_n, par_node_n):
